...
export default function ContactUsPage() {
  ...
  function postData(e) {
    ...
    if (error) setShow(true);
      ...
      dispatch(
        createContactUs({ ...data, active: true, date: new Date().toISOString() }),
      );
      setMessage(
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-3 col-sm-6 card bg-primary p-4 mb-5 border-5 border-light">
              ...
              <p className="text-light text-center">{siteConfig.addressFull}</p>
            </div>
            <div className="col-md-3 col-sm-6 card bg-primary p-4 mb-5 border-5 border-light">
              <h3 className="text-light text-center">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
              <div className="h-100" style={{ minHeight: "400px" }}>
                <iframe
                  ...
                  height="600"
                  id="gmap_canvas"
                  src={`https://maps.google.com/maps?q=${encodeURIComponent(siteConfig.mapQuery)}&t=&z=13&ie=UTF8&iwloc=&output=embed`}
                ></iframe>
              </div>
            </div>
          </div>
